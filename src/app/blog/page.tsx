            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
              {(categories.length > 0 ? categories.slice(0, 4) : featuredCategories).map((category) => (
                <Link key={category.id} href={`/blog/category/${category.slug}`}>
                  <Card className="hover:shadow-md transition-shadow cursor-pointer h-full bg-gray-700 border-gray-600">
                    <CardContent className="p-4 text-center">
                      ...
                      <h3 className="font-semibold text-sm mb-1 text-gray-100">{category.name}</h3>
          ...
          <div className="max-w-2xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 max-w-md mx-auto">
              <input
                ...
                className="flex-1 px-4 py-3 rounded-lg text-gray-100 bg-gray-800 placeholder-gray-400 border-gray-600"
              />
              <Button 
                variant="secondary" 
