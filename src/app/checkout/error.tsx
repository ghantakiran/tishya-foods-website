  ...
  return (
    <html>
      <body style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '100vh', background: '#fff8f0' }}>
        <h1 style={{ color: '#b91c1c', fontSize: '2rem', marginBottom: '1rem' }}>Checkout Error</h1>
        <p style={{ color: '#333', marginBottom: '2rem' }}>{error.message || 'An error occurred during checkout.'}</p>
        ...
        <Link href="/checkout">
          <span style={{ color: '#2563eb', textDecoration: 'underline', cursor: 'pointer' }}>Back to Checkout</span>
        </Link>
      </body>
    </html>
  );
