  ...
  return (
    <div className="pt-20 min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
            <div className="text-center">
              ...
              <h3 className="font-semibold text-brown-800 mb-2">Earn While You Shop</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-brown-800 mb-2">Exclusive Rewards</h3>
              <p className="text-sm text-brown-600">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-brown-800 mb-2">Tier Benefits</h3>
              <p className="text-sm text-brown-600">
            ...
            <div className="text-center">
              ...
              <h3 className="font-semibold text-brown-800 mb-2">Refer & Earn</h3>
              <p className="text-sm text-brown-600">
        ...
        >
          <h3 className="text-xl font-bold text-brown-800 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="flex items-start space-x-3">
              ...
              <div className="text-left">
                <h4 className="font-semibold text-brown-800">Shop & Earn</h4>
                <p className="text-sm text-brown-600">Make purchases and automatically earn points</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-8 h-8 bg-brown-800 text-white rounded-full flex items-center justify-center text-sm font-bold">2</div>
              <div className="text-left">
                <h4 className="font-semibold text-brown-800">Unlock Tiers</h4>
                <p className="text-sm text-brown-600">Accumulate points to reach higher tiers with better benefits</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              <div className="w-8 h-8 bg-brown-800 text-white rounded-full flex items-center justify-center text-sm font-bold">3</div>
              <div className="text-left">
                <h4 className="font-semibold text-brown-800">Redeem Rewards</h4>
                <p className="text-sm text-brown-600">Use points for discounts, free products, and exclusive experiences</p>
              </div>
            </div>
          </div>
        </motion.div>
