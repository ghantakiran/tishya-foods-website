          ...
          >
            ...
            <div className="grid md:grid-cols-3 gap-8 mt-12">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-brown-800 mb-2">Goal-Based Matching</h3>
              ...
              >
                <div className="w-16 h-16 bg-primary-500 rounded-2xl flex items-center justify-center mx-auto mb-4">
                  <Sparkles className="h-8 w-8 text-brown-800" />
                </div>
                <h3 className="text-xl font-bold text-brown-800 mb-2">Smart Analysis</h3>
                <p className="text-brown-600">
              ...
              >
                ...
                <h3 className="text-xl font-bold text-brown-800 mb-2">Instant Results</h3>
                <p className="text-brown-600">
            ...
            {[
              ...
              >
                <div className="relative mb-6">
                  ...
                  <div className="absolute -top-2 -right-2 w-8 h-8 bg-primary-500 rounded-full flex items-center justify-center text-brown-800 font-bold text-sm">
                    {item.step}
                  </div>
                </div>
                <h3 className="text-xl font-bold text-brown-800 mb-3">{item.title}</h3>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <h3 className="font-semibold text-brown-800 mb-1">Scientifically Backed</h3>
                    <p className="text-brown-600">Our algorithms are based on nutritional science and dietary research</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-6 h-6 bg-brown-800 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    <h3 className="font-semibold text-brown-800 mb-1">Personalized Results</h3>
                    <p className="text-brown-600">No two recommendations are the same - every suggestion is tailored to you</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-6 h-6 bg-brown-800 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    <h3 className="font-semibold text-brown-800 mb-1">Save Time & Money</h3>
                    <p className="text-brown-600">Stop guessing which products to buy - get exactly what works for your goals</p>
                  </div>
                </div>
                <div className="flex items-start space-x-4">
                  <div className="w-6 h-6 bg-brown-800 rounded-full flex items-center justify-center flex-shrink-0 mt-1">
                  ...
                  <div>
                    <h3 className="font-semibold text-brown-800 mb-1">Continuous Learning</h3>
                    <p className="text-brown-600">Our AI gets smarter with every recommendation, improving accuracy over time</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              >
                <Sparkles className="h-6 w-6 text-brown-800" />
              </motion.div>
              ...
              >
                <Target className="h-6 w-6 text-brown-800" />
              </motion.div>
            </motion.div>
          </div>
        </div>
