      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            {/* Badge */}
            <motion.div
              className="inline-flex items-center space-x-2 bg-primary-100 text-brown-800 px-4 py-2 rounded-full text-sm font-medium"
            ...
            <div className="space-y-4">
              <motion.h1
                className="text-4xl sm:text-5xl lg:text-6xl font-bold text-brown-800 leading-tight font-montserrat"
              ...
              <motion.p
                className="text-xl sm:text-2xl text-brown-600 max-w-2xl"
                initial={{ opacity: 0, y: 30 }}
                animate={{ opacity: 1, y: 0 }}
            ...
            >
              {features.map((feature, index) => (
                <div key={index} className="flex items-center space-x-2 text-brown-700">
            ...
            {/* Process Description */}
            <motion.p
              className="text-brown-600 max-w-lg leading-relaxed"
              initial={{ opacity: 0, y: 30 }}
              animate={{ opacity: 1, y: 0 }}
            ...
            >
              <div className="text-center">
                <div className="text-2xl font-bold text-brown-800">1000+</div>
                <div className="text-sm text-brown-600">Happy Customers</div>
              </div>
              <div className="w-px h-10 bg-primary-300"></div>
              <div className="text-center">
                <div className="text-2xl font-bold text-brown-800">100%</div>
                <div className="text-sm text-brown-600">Natural Ingredients</div>
              </div>
              <div className="w-px h-10 bg-primary-300"></div>
              <div className="text-center">
                <div className="text-2xl font-bold text-brown-800">50+</div>
                <div className="text-sm text-brown-600">Product Varieties</div>
              </div>
            </motion.div>
          </motion.div>
          ...
          >
            <div className="relative w-full max-w-lg mx-auto">
              ...
              >
                <div className="text-brown-800 font-bold text-4xl font-montserrat">
                  Tishya
                </div>
              </motion.div>
              ...
              <motion.div
                className="absolute -bottom-4 -left-4 bg-brown-800 text-white px-3 py-1 rounded-full text-sm font-semibold shadow-lg"
                animate={{ y: [0, 5, 0] }}
